...
describe("Permission System", () => {
  ...
  describe("hasAllPermissions", () => {
    it("should return true when user has all permissions", async () => {
      const user = createUserWithPermissions([Permission.READ_CONTENT, Permission.CREATE_CONTENT]);
  ...
  describe("Validation", () => {
    it("should validate permission assignment", () => {
      ...
      const adminAssignment = validatePermissionAssignment(UserRole.ADMIN, UserRole.USER, [
        Permission.READ_CONTENT,
        Permission.CREATE_CONTENT,
      ]);
      ...
      const editorAssignment = validatePermissionAssignment(UserRole.EDITOR, UserRole.USER, [
      ...
      const userAssignment = validatePermissionAssignment(UserRole.USER, UserRole.USER, [
        Permission.READ_CONTENT,
      ]);
